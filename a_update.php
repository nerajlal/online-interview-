       ...
       <form action="" method="POST">
		<div class="card card-default">
           ...
           <?php
              ...
              $result = mysql_query("SELECT * FROM users where type='admin'");
...
<?php
							 ...
							 if(isset($_POST['submit']))
							 {
								 ...
								 $sql="update users set password='$_POST[password]' where type='admin'";
								 echo"$sql";
								...
								{
									echo "<script>alert('Not updated!');location.href='a_update.php';</script>";
								}
							 }	
